...
This project uses a .env file to manage sensitive API keys and Neo4j username and pass. To set it up:
...
## 3.🚀 Running the 
Once your environment is set up and activated, you can start the Knowledge-Graph-Agent by running:
* **Bash**
python main.py
